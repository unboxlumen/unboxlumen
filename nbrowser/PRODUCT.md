...
| 当前版本 | v0.0.7（versionCode 7 / versionName 0.0.7，见 app/build.gradle） |
| 安装包大小 | 约 1.9 MB（Release APK） |
...
- **大小统计口径**：后续发布只统计 release 包；debug 包单独说明，不计入大小统计（当前实测：v0.0.7 release ≈ 1.90 MB，v0.0.7 debug ≈ 9.23 MB 仅作说明）。
