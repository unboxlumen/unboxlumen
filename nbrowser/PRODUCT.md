...
| 当前版本 | v0.0.16（versionCode 16 / versionName 0.0.16，见 app/build.gradle） |
| 安装包大小 | 约 2.1 MB（v0.0.16 release：2,184,986 B ≈ 2.08 MB，见 GitHub Release 实际附件） |
...
3. **追求轻量**：Release 包约 2.1 MB，功能取舍以"速度优先、功能够用"为准。
...
- **大小统计口径**：后续发布只统计 release 包；debug 包单独说明，不计入大小统计（当前实测：v0.0.16 release ≈ 2.08 MB，v0.0.16 debug ≈ 9.95 MB 仅作说明）。
