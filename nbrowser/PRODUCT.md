...
| 当前版本 | v0.0.6（versionCode 6 / versionName 0.0.6，见 app/build.gradle） |
...
- **大小统计口径**：后续发布只统计 release 包；debug 包单独说明，不计入大小统计（当前实测：v0.0.6 release ≈ 1.89 MB，v0.0.6 debug ≈ 9.22 MB 仅作说明）。
