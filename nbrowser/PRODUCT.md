...
| 当前版本 | v0.0.15（versionCode 15 / versionName 0.0.14，见 app/build.gradle） |
| 安装包大小 | 约 2.1 MB（v0.0.15 release：2,181,750 B ≈ 2.08 MB，见 GitHub Release 实际附件） |
...
- **大小统计口径**：后续发布只统计 release 包；debug 包单独说明，不计入大小统计（当前实测：v0.0.15 release ≈ 2.00 MB，v0.0.15 debug ≈ 9.62 MB 仅作说明）。
