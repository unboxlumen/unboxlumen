...
| 当前版本 | v0.0.8（versionCode 8 / versionName 0.0.8，见 app/build.gradle） |
| 安装包大小 | 约 1.9 MB（v0.0.8 release：1,954,849 B ≈ 1.86 MB，见 GitHub Release 实际附件） |
...
- **大小统计口径**：后续发布只统计 release 包；debug 包单独说明，不计入大小统计（当前实测：v0.0.8 release ≈ 1.86 MB，v0.0.8 debug ≈ 9.38 MB 仅作说明）。
