...
| 当前版本 | v0.0.18（versionCode 18 / versionName 0.0.18，见 app/build.gradle） |
| 安装包大小 | 约 2.1 MB（v0.0.18 release：2,189,727 B ≈ 2.09 MB，见 GitHub Release 实际附件） |
...
- **大小统计口径**：后续发布只统计 release 包；debug 包单独说明，不计入大小统计（当前实测：v0.0.18 release ≈ 2.09 MB，v0.0.18 debug ≈ 9.78 MB 仅作说明）。
