...
2. **开源、Apache 2.0**：与 UnboxLumen 主线产品（N 浏览器、N 文件、N 搜索）的闭源策略不同；nDebugBar 采用 Apache License 2.0，可自由使用、修改、商用（保留版权声明）。
...
3. **不得隐去 Apache 2.0 许可**（开源项目必须明示 License）。
